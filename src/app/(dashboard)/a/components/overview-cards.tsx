        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {metrics.map((metric, index) => {
                ...
                return (
                    <Card
                        key={index}
                        className="group relative overflow-hidden bg-white hover:bg-white/90 border-secondary-100 shadow-sm hover:shadow-md transition-all duration-200"
                    >
                        ...
                        <CardContent className="relative">
                            <div className="flex items-baseline gap-3">
                                <div className="text-3xl font-bold text-secondary-900 tracking-tight">{metric.value}</div>
                                <div

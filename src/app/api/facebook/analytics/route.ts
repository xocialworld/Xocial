 ...
 * Get Facebook analytics with trends
 */
export const GET = withErrorHandler(async (request: NextRequest) => {
    ...
    try {
        ...
        if (accountError || !account) {
            throw new APIError(404, 'Facebook account not found', 'ACCOUNT_NOT_FOUND');
        }
        ...
        logger.info(`[Facebook Analytics] Fetched analytics for ${accountId}`);

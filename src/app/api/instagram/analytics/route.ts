 ...
 * Get Instagram analytics with trends
 */
    ...
    try {
        ...
        const currentTotals = (posts || []).reduce((acc, post: any) => {
            ...
            return {
                ...
                saves: acc.saves + (analytics.saves || 0),
                shares: acc.shares + (analytics.shares || 0),
            };
        }, { impressions: 0, reach: 0, engagement: 0, likes: 0, comments: 0, saves: 0, shares: 0 });
        ...
        logger.info(`[Instagram Analytics] Fetched analytics for ${accountId}`);

...
} from '@/components/shared/keyboard-shortcuts-help';
    ...
    <>
      ...
      >
        ...
        >
          ...
          {(!collapsed || isMobile) && <span className="text-lg font-bold text-white">Xocial</span>}
        </Link>
      ...
      {/* Navigation */}
      <nav className={cn('flex-1 py-3 overflow-y-auto', collapsed && !isMobile ? 'px-2' : 'px-3')}>
      ...
      {/* Bottom section */}
      <div
        className={cn('border-t border-white/10 py-2', collapsed && !isMobile ? 'px-2' : 'px-3')}
      >
        <button
